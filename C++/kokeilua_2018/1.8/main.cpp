...
std::vector<henkilot *> VectorOfObjects; /*! Henkiloluokan Global vectori.  !*/
...
{
public:
    void printInfo() /*! Printtaa kaikki vektorista loytyvat oliot ja niiden tiedot.*/
    {
    ...
    void addObjects() /*!Ensimmainen valinta. Tama lisaa joko tyontekija tai student olion vectoriin.*/
    {
    ...
    void poistaVektori() /*!Tama toiminto poistaa vektorista olioita. Ensin varmistetaan, etta vektori ei ole jo tyhja.*/
    {
    ...
    void montakoVektori() /*!Tama toiminto katsoo montako oliota vektorista loytyy ja ilmoittaa sen kayttajalle*/
    {
        std::cout << "\nThere are " << VectorOfObjects.size() << " people in the system\n\n";
    }
    void tutkiVektori() /*! Tama on hakutoiminto. Tama toiminto ensin katsoo onko vektori tyhja, jos on ilmoittaa siita.*/
    {
    ...
    void etsiOlio() /*!Tama toiminto etsii for-loopilla hetun avulla oikean olion, ottaa sen kasittelyyn ja muokkaa halutun tiedon kayttajan toivomaksi.*/
    {
        lukumaara = VectorOfObjects.size();
            if (lukumaara == 0) {
    ...
    void lasketaanPalkka() /*! Tama toiminto laskee kayttajalle tuntipalkan kayttaen hyvaksi templatea!*/
    {
...
int main () {
    ...
    ohjelmaFacade of; /*! Luodaan ohjelmaFacaadee. Designpattern facade. !*/
    ...
    if (valinta == "1") {
        of.addObjects();                                /*!Ensimmainen valinta. Tama lisaa joko tyontekija tai student olion vectoriin.*/
        goto alku;                                      /*! Palataan ohjelman alkuun !*/
    }else if (valinta == "3"){
        of.printInfo();                             /*! Printtaa kaikki vektorista loytyvat oliot ja niiden tiedot.*/
        goto alku;                                  /*! Palataan ohjelman alkuun !*/
    }else if (valinta == "2") {
        of.poistaVektori();                             /*!Tama toiminto poistaa vektorista olioita. Ensin varmistetaan, etta vektori ei ole jo tyhja.*/
        goto alku;                                      /*! Palataan ohjelman alkuun !*/
    }else if (valinta == "4") {
        of.montakoVektori();                            /*!Tama toiminto katsoo montako oliota vektorista loytyy ja ilmoittaa sen kayttajalle*/
        goto alku;
    }else if (valinta == "5") {
        of.tutkiVektori();                              /*! Tama on hakutoiminto. Tama toiminto ensin katsoo onko vektori tyhja, jos on ilmoittaa siita.*/
        goto alku;                                      /*! Palataan ohjelman alkuun !*/
    }else if (valinta == "6") {
        of.etsiOlio();                                  /*!Tama toiminto etsii for-loopilla hetun avulla oikean olion, ottaa sen kasittelyyn ja muokkaa halutun tiedon kayttajan toivomaksi.*/
        goto alku;                                      /*! Palataan ohjelman alkuun !*/
    }else if (valinta == "8") {
        std::cout << "\nHyvaa yota.\n";                 /*! Ohjelma sammuu !*/
    }else if (valinta == "7") {
        of.lasketaanPalkka();                           /*! Tama toiminto laskee kayttajalle tuntipalkan kayttaen hyvaksi templatea!*/
        goto alku;                                      /*! Palataan ohjelman alkuun !*/
    }else{
